...
CanvasEngine.getJSON = function (a, b, d) {
    ...
    CanvasEngine.ajax({
        url: a+'?v='+parseInt(Math.random()*99999999),
        dataType: "json",
        data: b,
        success: d
    })
...
Class.create("Window", {
    ...
    position: function (b, e) {
        ...
        if (e === undefined) {
            if (b == "middle") {
                ...
                if (b == "bottom") {
                    this.el.x = 0;
                    this.el.y = a.height - this.height;
                } else {
                    if (b == "top") {
                        this.el.x = a.width / 2 - this.width / 2;
    ...
    setBackground: function (a, w, h) {
		...
		thumbImg.src = 'http://odinai.com/chronoworld/Graphics/Windowskins/window_full.png';
		thumbImg.onload = function() {
			d.drawImage(thumbImg, 0, 0, w, h);
		};
